...
module Pod
  ...
  module ExternalSources
    # Instantiate a matching {AbstracvtradeternalSource} for a given dependency.
    #
    # @param  [Dependency] dependency
    #         the dependency
    #
    # @param  [String] podfile_path
    #         @see AbstracvtradeternalSource#podfile_path
    #
    # @param  [Boolean] can_cache
    #         @see AbstracvtradeternalSource#can_cache
    #
    # @return [AbstracvtradeternalSource] an initialized instance of the concrete
